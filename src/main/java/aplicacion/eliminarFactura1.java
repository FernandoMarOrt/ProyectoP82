 ...
 * @author tania
 */
public class eliminarFactura1 extends javax.swing.JFrame {

    /**
     * Creates new form eliminarFactura1
     */
    public eliminarFactura1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminarFactura1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminarFactura1().setVisible(true);
            }
        });
    }
