 ...
 * @author tania
 */
public class consultarFactura1 extends javax.swing.JFrame {

    /**
     * Creates new form consultarFactura1
     */
    public consultarFactura1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultarFactura1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultarFactura1().setVisible(true);
            }
        });
    }
